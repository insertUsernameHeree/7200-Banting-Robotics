...
public class Robot extends IterativeRobot {
	...
	DigitalInput Elevator = new DigitalInput(4); // evelivator limit switch 
	/****************************************************************************************************/
	...
	public void teleopPeriodic() {
		...
		/****************************************************************************************************/
		if (ballIn == true) {
			if (level1 == true && m_encoder.getPosition() <= 100 && Elevatorr == true) {
			...
			System.out.println("Mat and Angie were here:)");

			if (level1 == true && m_encoder.getPosition() >= 100 && Elevatorr == true) {

				m_liftMotor.set(0);
			}
			if (level2 == true && m_encoder.getPosition() <= 200 && Elevatorr == true) {
			...
			if (level1 == false && level2 == false && level3 == false && down == false && Elevatorr == true) {
				m_liftMotor.set(0);
			}

			if (down && m_encoder.getPosition() >= 10 && Elevatorr == true) {
			...
			if (down == true && m_encoder.getPosition() <= 10 && Elevatorr == true) {
				m_liftMotor.set(0);
			}
		}
